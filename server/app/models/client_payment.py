...
class ClientPayment(Base):
    ...
    part1_reference_no = Column(String, nullable=True)
    ...
    part2_reference_no = Column(String, nullable=True)
    ...
    miscellaneous_reference_no = Column(String, nullable=True)
    ...
    def to_dict(self):
        return {
            ...
            "part1_reference_no": self.part1_reference_no,
            ...
            "part2_reference_no": self.part2_reference_no,
            ...
            "miscellaneous_reference_no": self.miscellaneous_reference_no,
